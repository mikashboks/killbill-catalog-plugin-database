...
public class CatalogDatabaseListener implements OSGIKillbillEventDispatcher.OSGIKillbillEventHandler {

    private static final Logger logger = LoggerFactory.getLogger(CatalogDatabaseListener.class);

    private final OSGIKillbillAPI osgiKillbillAPI;

    public CatalogDatabaseListener(final OSGIKillbillAPI killbillAPI) {
