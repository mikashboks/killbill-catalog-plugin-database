...
@Singleton
@Path("/healthcheck")
public class CatalogDatabaseHealthcheckServlet extends PluginHealthcheck {

    private final CatalogDatabaseHealthcheck healthcheck;

    @Inject
    public CatalogDatabaseHealthcheckServlet(final CatalogDatabaseHealthcheck healthcheck) {
